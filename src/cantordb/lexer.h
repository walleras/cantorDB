...
TOK_PROPERTY, TOK_INTEGER, TOK_STRING, TOK_DECIMAL, TOK_LONG, TOK_BOOL, TOK_COMMA, TOK_CARDINALITY, TOK_DISJOINT, TOK_EQUIV, TOK_PROPER, TOK_COMPLEMENT, TOK_CLEAR, TOK_RENAME, TOK_UPDATE, TOK_SAVE, TOK_LOAD, TOK_KEY, TOK_UNIVERSAL, TOK_RESTORE, TOK_AND, TOK_NOR, TOK_OR, TOK_NAND, TOK_XOR, TOK_NOT};
